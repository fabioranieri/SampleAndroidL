...
package org.fingerlinks.mobile.android.samplel.service;
...
import org.fingerlinks.mobile.android.samplel.TestJobServiceActivity;
...
public class TestJobService extends JobService {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        m.what = TestJobServiceActivity.MSG_SERVICE_OBJ;
        m.obj = this;
        try {
            callback.send(m);
    ...
    TestJobServiceActivity mActivity;
    private final LinkedList<JobParameters> jobParamsMap = new LinkedList<JobParameters>();

    public void setUiCallback(TestJobServiceActivity activity) {
        mActivity = activity;
    }
